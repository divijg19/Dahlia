...
class DahliaAnalytics:
    ...
    def _parse_log_line(self, line: str) -> None:
        ...
        if "[INFO]" in line and "GET" in line:
            ...
            self.error_data.append({"timestamp": datetime.now(), "message": line})
...
def main():
    ...
    parser.add_argument(
        "--log-file", default="/tmp/dahlia.log", help="Path to log file"
    )
    parser.add_argument(
        "--output", default="analytics_report.json", help="Output file for report"
    )
    parser.add_argument(
